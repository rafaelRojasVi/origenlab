...
| **F — Incident regression pack** | Broader end-to-end incident-chain regressions | **Implemented by this draft PR** (not merged) |
...
- `tests/test_sqlite_cutover_incident_regression_pack.py` — PR-F end-to-end incident-chain regressions (draft until merged)
