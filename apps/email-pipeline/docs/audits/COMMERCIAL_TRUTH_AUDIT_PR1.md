...
| PR3 | Opportunity stage model from existing mart/intel/deal evidence — see [`COMMERCIAL_OPPORTUNITY_STAGE_READ_MODEL_PR3.md`](COMMERCIAL_OPPORTUNITY_STAGE_READ_MODEL_PR3.md) |
