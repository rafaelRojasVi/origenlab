...
**Active operator UI:** [`apps/dashboard`](../../dashboard/README.md) (React) + [`apps/api`](../../api/README.md) (read API on **:8001**) over the **Postgres mirror**. Streamlit Python UI **removed** (2026-06-04).
