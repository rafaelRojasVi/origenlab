...
| `scripts/commercial/build_commercial_procurement_institution_prospect_plan.py` | OPS_AUDIT | **PR5E.1** read-only institution prospect intelligence over PR5C/D/E (live + PR4): one profile per deterministic buyer identity with equipment history, account/contact overlay, and three independent axes; no persistence/outreach; stacked on PR5B.2 — see [`COMMERCIAL_PROCUREMENT_INSTITUTION_PROSPECTS_PR5E1.md`](audits/COMMERCIAL_PROCUREMENT_INSTITUTION_PROSPECTS_PR5E1.md) |
