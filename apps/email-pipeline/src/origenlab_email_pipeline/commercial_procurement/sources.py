...
def _line_from_parts(
    *,
    ...
    return {
        ...
        "resolution_buyer_name_norm": buyer.get("resolution_buyer_name_norm"),
        "resolution_buyer_domain": buyer.get("resolution_buyer_domain"),
        "resolution_contact_email": buyer.get("resolution_contact_email"),
        "resolution_email_domain": buyer.get("resolution_email_domain"),
        "display_policy": buyer.get("display_policy"),
