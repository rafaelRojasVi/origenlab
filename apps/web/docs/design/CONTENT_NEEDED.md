...
| **Permiso escrito de Ortoalresa para las cinco fotografías publicadas y para su marca** | CONTENIDO | TODO abierto desde 2026-05 y **urgente desde 2026-09-07**: el Aviso Legal del fabricante (ortoalresa.com/aviso-legal) reserva la reproducción de sus imágenes y el uso de su logotipo a la autorización expresa. Las cinco imágenes siguen publicadas por decisión del negocio (fase 2) con procedencia por modelo en `src/data/productImages.ts`. Enviar a marketing@ortoalresa.com la petición redactada en `docs/product-assets.md` |
...
| Fotografía de equipo de Hielscher, IKA, Adam Equipment, Löser y SERVA | CONTENIDO | Investigación de imagen del 2026-09-07 en los seis dominios oficiales: ninguno publica portal de prensa, paquete de imágenes para distribuidores ni términos de reutilización; Hielscher, Löser y Ortoalresa prohíben expresamente la reproducción sin consentimiento, SERVA y Adam sólo reservan derechos, e IKA no se puede leer por máquina (403). Las 19 fotografías identificadas modelo por modelo están en `src/data/productImages.ts` como `ASSET_PERMISSION_NEEDED`, con la petición que hay que enviar a cada fabricante (`docs/product-assets.md`). Mientras tanto las cinco familias se componen con el diagrama propio, y las fichas y filas se componen a texto sin reservar hueco |
...
| Fotografía de producto de familias distintas de centrifugación | CONTENIDO | Toda la fotografía publicable del repositorio es de centrífugas Ortoalresa (5 filas `VERIFIED` en `productImages.ts`). Las otras cinco familias usan un diagrama propio y la portada no abre con fotografía. Ver la fila de permisos de fotografía en la sección 2 |
