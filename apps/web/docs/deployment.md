...
Las rutas `/privacidad/`, `/cookies/`, `/aviso-legal/` y `/newsletter/` se
...
- [ ] Ejecutar `npm run validate` (incluye `build`, `validate:dist` y `validate:privacy`) y revisar que no haya errores.
