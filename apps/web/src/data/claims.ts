...
export const claims: readonly Claim[] = [
  ...
  },
  {
    ...
    text: '1 referencia con ficha publicada',
    value: 1,
    source:
      "src/data/products.ts, productos con brandId 'serva': sólo BlueSlick 42500.01. TEMED y REPEL-SILANE se retiraron el 2026-09-07 por no poder verificar su identidad exacta en el catálogo del fabricante",
  ...
  {
    id: 'equipos-serva-documentados',
    text: '4 equipos con documentación del fabricante',
    value: 4,
    source:
      "src/data/brandModels.ts, entradas con brandId 'serva': BlueVertical PRiME, HPE BlueHorizon, BlueMarine 100 y la familia BluePower. Cada una con la URL del fabricante comprobada el 2026-09-07",
    measuredOn: '2026-09-07',
    approvedBy: 'Revisión de catálogo del 2026-09-07, contra la fuente oficial',
    approvedOn: '2026-09-07',
    status: 'approved',
    visibility: 'public',
  },
