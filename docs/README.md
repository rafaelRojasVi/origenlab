...
|---|---|
| [`DOMAIN.md`](DOMAIN.md) | Glossary; organization / unit / domain / person / affiliation / contact-point semantics; prospect vs lead vs signal vs opportunity vs quote; product / manufacturer / supplier; address and opportunity-participant semantics; identity, merge and evidence-promotion principles; the commercial case; **the 36-table inventory** |
